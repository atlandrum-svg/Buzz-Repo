...
func _register_cheats() -> void:
	...
	_add("wheel_possess", KEY_F8, "Run fireman wheel forced onto Possess", "cheat_wheel_land_possess")
	_add("give_demon", KEY_F9, "Give demon debuff + ADHD buff", "cheat_give_demon_and_adhd")
	_add("tech_stats", KEY_F10, "Reset tech-bro base stats", "cheat_reset_tech_stats")
